...
peerjs --port 443 --key peerjs --path /peerjs --sslkey "/etc/letsencrypt/live/chat-app.byme.vn/privkey.pem" --sslcert "/etc/letsencrypt/live/chat-app.byme.vn/cert.pem"
